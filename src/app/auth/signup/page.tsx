                ...
                <div className="bg-white relative rounded-3xl shadow-xl flex items-center justify-between px-2 max-w-4xl overflow-hidden">
                    ...
                    {otpVerification ? (
                        ...
                        <div className="left max-w-xl px-2 md:px-5 py-6 z-10">
                            ...
                            <p className={`my-2 mb-4 w-full py-2 px-2  border-l-2 ${error ? " border-red-500 bg-red-100 text-red-600 " : " border-slate-700 bg-slate-100 text-gray-600 "}  truncate text-sm`}>{error ? error : "Name and Email are required to register"}</p>
                            ...
                            <div className="classical-login my-5  mt-2 min-w-80">
                                <form className='flex flex-col items-center justify-center gap-5' onSubmit={handleFormSubmit}>
                                    <InputBox value={formData.name} onChange={handleFormDataChange} name={"name"} type="text" label="Enter name" required={true} />
                                    <InputBox value={formData.email} onChange={handleFormDataChange} name={"email"} type='email' label="Enter email" required={true} />
                            ...
                            <div className="w-full text-center font-light text-slate-500 text-sm mt-5">
                                ...
                                <span className="text-blue-600 font-medium bg-blend-lighten cursor-pointer" onClick={() => router.push('/auth/login')}>
                                    Sign in
                                </span>
                            </div>
                        </div>
