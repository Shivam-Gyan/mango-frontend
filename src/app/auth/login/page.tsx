                ...
                <div className="bg-white relative rounded-3xl shadow-xl flex items-center justify-between px-2 max-w-4xl overflow-hidden">
                    ...
                    {otpVerification ? (
                        ...
                        <div className="left max-w-xl px-2 md:px-5 py-6 z-10">
                            ...
                            <p className={`my-2 mb-3 w-full py-2 px-2 border-l-2 ${error ? " border-red-500 bg-red-100 text-red-600 " : " border-slate-700 bg-slate-100 text-gray-600 "}  truncate text-sm`}>{error ? error : "Enter the email login to your account"}</p>
